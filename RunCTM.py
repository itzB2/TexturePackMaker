...
parser.add_argument("EdgeLength", type=int, help="The value that descibes how wide a side is aka Edge Length", default=1)

args = parser.parse_args()

POG = Full(args.image, args.SavePath, args.imageWithNoSides, args.OldBlockID, args.NewBlockID, args.Metadata, args.EdgeLength)
POG.run()